...
res_v_L <- function(prof, bbox){
  temp <- st_crop(prof, bbox)
  temp <- filter(temp, distance_from_point_m_L < 500)
  temp$xmin <- temp$profsum - temp$dist
  ggplot() + geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =0, xmax =DEP_BOT_1_L, fill = RHO_I_1_L))+ geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =DEP_BOT_1_L, xmax =DEP_BOT_2_L, fill = RHO_I_2_L))+ geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =DEP_BOT_2_L, xmax =DEP_BOT_3_L, fill = RHO_I_3_L)) + geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =DEP_BOT_3_L, xmax =DEP_BOT_4_L, fill = RHO_I_4_L))+ geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =DEP_BOT_4_L, xmax =DEP_BOT_5_L, fill = RHO_I_5_L))+ geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =DEP_BOT_5_L, xmax =DEP_BOT_6_L, fill = RHO_I_6_L))+ geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =DEP_BOT_6_L, xmax =DEP_BOT_7_L, fill = RHO_I_7_L)) + geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =DEP_BOT_7_L, xmax =DEP_BOT_8_L, fill = RHO_I_8_L)) + geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =DEP_BOT_8_L, xmax =DEP_BOT_9_L, fill = RHO_I_9_L))+ geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =DEP_BOT_9_L, xmax =DEP_BOT_10_L, fill = RHO_I_10_L))+ geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =DEP_BOT_10_L, xmax =DEP_BOT_11_L, fill = RHO_I_11_L))+ geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =DEP_BOT_11_L, xmax =DEP_BOT_12_L, fill = RHO_I_12_L))+ geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =DEP_BOT_12_L, xmax =DEP_BOT_13_L, fill = RHO_I_13_L))+ geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =DEP_BOT_13_L, xmax =DEP_BOT_14_L, fill = RHO_I_14_L))+ geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =DEP_BOT_14_L, xmax =DEP_BOT_15_L, fill = RHO_I_15_L))+ geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =DEP_BOT_15_L, xmax =DEP_BOT_16_L, fill = RHO_I_16_L))+ geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =DEP_BOT_16_L, xmax =DEP_BOT_17_L, fill = RHO_I_17_L))+ geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =DEP_BOT_17_L, xmax =DEP_BOT_18_L, fill = RHO_I_18_L))+ geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =DEP_BOT_18_L, xmax =DEP_BOT_19_L, fill = RHO_I_19_L))+ geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =DEP_BOT_19_L, xmax =DEP_BOT_20_L, fill = RHO_I_20_L))+scale_y_reverse()+scale_fill_viridis_c('Resistivity (ohm-m)', option = 'turbo', limits = c(0,500))+labs(x="Depth (m)", y = "Profile Distance (m)")
}
...
res_v_R <- function(prof, bbox){
  temp <- st_crop(prof, bbox)
  temp <- filter(temp, distance_from_point_m_R < 500)
  temp$xmin <- temp$profsum - temp$dist
  ggplot() + geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =0, xmax =DEP_BOT_1_R, fill = RHO_I_1_R))+ geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =DEP_BOT_1_R, xmax =DEP_BOT_2_R, fill = RHO_I_2_R))+ geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =DEP_BOT_2_R, xmax =DEP_BOT_3_R, fill = RHO_I_3_R)) + geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =DEP_BOT_3_R, xmax =DEP_BOT_4_R, fill = RHO_I_4_R))+ geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =DEP_BOT_4_R, xmax =DEP_BOT_5_R, fill = RHO_I_5_R))+ geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =DEP_BOT_5_R, xmax =DEP_BOT_6_R, fill = RHO_I_6_R))+ geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =DEP_BOT_6_R, xmax =DEP_BOT_7_R, fill = RHO_I_7_R)) + geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =DEP_BOT_7_R, xmax =DEP_BOT_8_R, fill = RHO_I_8_R)) + geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =DEP_BOT_8_R, xmax =DEP_BOT_9_R, fill = RHO_I_9_R))+ geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =DEP_BOT_9_R, xmax =DEP_BOT_10_R, fill = RHO_I_10_R))+ geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =DEP_BOT_10_R, xmax =DEP_BOT_11_R, fill = RHO_I_11_R))+ geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =DEP_BOT_11_R, xmax =DEP_BOT_12_R, fill = RHO_I_12_R))+ geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =DEP_BOT_12_R, xmax =DEP_BOT_13_R, fill = RHO_I_13_R))+ geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =DEP_BOT_13_R, xmax =DEP_BOT_14_R, fill = RHO_I_14_R))+ geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =DEP_BOT_14_R, xmax =DEP_BOT_15_R, fill = RHO_I_15_R))+ geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =DEP_BOT_15_R, xmax =DEP_BOT_16_R, fill = RHO_I_16_R))+ geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =DEP_BOT_16_R, xmax =DEP_BOT_17_R, fill = RHO_I_17_R))+ geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =DEP_BOT_17_R, xmax =DEP_BOT_18_R, fill = RHO_I_18_R))+ geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =DEP_BOT_18_R, xmax =DEP_BOT_19_R, fill = RHO_I_19_R))+ geom_rect(data = temp, mapping = aes(ymin = xmin, ymax = profsum, xmin =DEP_BOT_19_R, xmax =DEP_BOT_20_R, fill = RHO_I_20_R))+scale_y_reverse()+scale_fill_viridis_c('Resistivity (ohm-m)', option = 'turbo', limits = c(0,500))+labs(x="Depth (m)", y = "Profile Distance (m)")
}
...
for (i in 3:5){
  feb_temp_L[[i]] <- feb_temp_L[[i]] + coord_flip()+scale_x_reverse()
  feb_temp_R[[i]] <- feb_temp_R[[i]] + coord_flip()+scale_x_reverse()
}
...
for (i in 3:5){
  feb_ec_L[[i]] <- feb_ec_L[[i]] + coord_flip()+scale_x_reverse()
  feb_ec_R[[i]] <- feb_ec_R[[i]] + coord_flip()+scale_x_reverse()
}
```
...
for (i in 3:5){
  jul_temp_L[[i]] <- jul_temp_L[[i]] + coord_flip()+scale_x_reverse()
  jul_temp_R[[i]] <- jul_temp_R[[i]] + coord_flip()+scale_x_reverse()
}

jul_ec <- function(bbox, prof){
temp <- st_crop(prof, bbox)
tempmap <- ggplot() + geom_point(data = temp, aes(x = profsum, y = surfcond_corr, color = "Surface Background")) + geom_point(data = temp, aes(x = profsum, y = deepcond_corr, color = 'Deep Background'))+ labs(x = "Profile Distance (m)", y = "Conductivity (us/cm)", color = "")+ ylim(c(125, 160))
if (nrow(filter(temp, anom_sec == 1))>0){
  tempmap <- tempmap + geom_point(data = filter(temp, anom_sec == 1), aes(x = profsum, y = surfcond_corr, color = "Surface Anomaly"))
}
if (nrow(filter(temp, anom_dec == 1))>0){
  tempmap <- tempmap + geom_point(data = filter(temp, anom_dec == 1), aes(x = profsum, y = deepcond_corr, color = "Deep Anomaly"))
}
tempmap + scale_color_manual(values = c("Surface Background" = "grey", "Deep Background" = "black", "Surface Anomaly" = "coral","Deep Anomaly" = "red"))
}
jul_ec_L <- lapply(bbox, jul_ec, prof = julleft_3857)
jul_ec_R <- lapply(bbox, jul_ec, prof = julright_3857)

for (i in 3:5){
  jul_ec_L[[i]] <- jul_ec_L[[i]] + coord_flip()+scale_x_reverse()
  jul_ec_R[[i]] <- jul_ec_R[[i]] + coord_flip()+scale_x_reverse()
}

```
Now make a plot sheet for each river segment/side/month:
```{r}
horiz <- rbind(c(1,1,1,1,1),
             c(1,1,1,1,1),
             c(2,2,2,2,2), 
             c(3,3,3,3,NA), 
             c(4,4,4,4,4))
